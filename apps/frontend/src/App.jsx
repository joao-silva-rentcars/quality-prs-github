...
function App() {
  ...
  const repoOptions = [
    ...
    { value: 'admin-produto', label: 'admin-produto' },
    { value: 'app-android', label: 'app-android' },
    { value: 'app-ios', label: 'app-ios' },
    { value: 'back-commercial', label: 'back-commercial' },
    { value: 'bidw', label: 'bidw' },
    { value: 'booking-api', label: 'booking-api' },
    { value: 'components', label: 'components' },
    { value: 'design-system', label: 'design-system' },
    { value: 'facade-mobile', label: 'facade-mobile' },
    { value: 'fortune-back', label: 'fortune-back' },
    { value: 'fortune-front', label: 'fortune-front' },
    { value: 'front-commercial', label: 'front-commercial' },
    { value: 'front-mobile', label: 'front-mobile' },
    { value: 'integrator-node', label: 'integrator-node' },
    { value: 'loyalty', label: 'loyalty' },
    { value: 'marketplace', label: 'marketplace' },
    { value: 'operation-front', label: 'operation-front' },
    { value: 'partner-integrator', label: 'partner-integrator' },
    ...
    { value: 'responsive-entrypages-backend', label: 'responsive-entrypages-backend' },
